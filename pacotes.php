...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Raleway:ital,wght@0,100;0,200;0,300;0,400;0,600;1,700&display=swap" rel="stylesheet" />
...
<body>
  ...
  <main class="container">
    ...
    <?php foreach ($dados as $registro) : ?>
      ...
      $valor_apresentavel = number_format($valor, 2, ",", ".")
      ...
      <form action="./finalizarPedido.php" method="POST">
        <div class="dados-form">
          ...
          <input type="hidden" name="Cidade_origem" value="<?php echo $origem; ?>">
          ...
          <div class="pacote">
            ...
            <div class="description">
              <div class="text">
                ...
                <h1 class="price">R$ <?php echo $valor_apresentavel; ?></h1>
